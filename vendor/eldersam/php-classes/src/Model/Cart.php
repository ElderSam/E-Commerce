...
class Cart extends Model {
    ...
    public function setFreight($nrzipcode){
        ...
        if($totals['nrqtd'] > 0){
            ...
            //dados para acessar a API do Correios
            if($totals['vlheight'] < 2) $totals['vlheight'] = 2; //altura mínima: 2cm
            if($totals['vllength'] < 16) $totals['vllength'] = 16; //comprimenro mínimo: 16cm
            if($totals['vlwidth'] < 11) $totals['vlwidth'] = 11; //largura mínima: 11cm
